...
const I18N = {
  ...
  dict: {
    ...
    // ---------- Print headers (xsheet/psheet column & section titles) ----------
    "م": "No.",
    "الخطوات": "Steps",
    "محتوى الفحص": "Inspection Content",
    "المعدات": "Equipment",
    "الفحص القياسي": "Standard Inspection",
    "متطلبات العمل": "Work Requirements",
    "الصور": "Photos",
    "إجراءات السلامة": "Safety",
    "معدل التكرار": "Repetition",
    "الإجراء عند الرفض": "Action if Rejected",
    "المسؤولية": "Responsibility",
    "بيئة الفحص": "Inspection Environment",
    "عدد مرات الفحص": "Inspection Frequency",
    "حالة الاعتماد": "Approval Status",
    "فيديو الفحص": "Video — Scan",
    "الدور": "Role",
    "الاسم": "Name",
    "الوظيفة": "Position",
    "التوقيع": "Signature",
